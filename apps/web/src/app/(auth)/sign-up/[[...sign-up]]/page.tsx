    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Create your Shipora account</h1>
        ...
        {hasClerk ? (
          ...
          <Card className="bg-card/70 border-border/60">
            <CardHeader className="text-center pb-4">
              <CardTitle className="text-base text-white">Get Started</CardTitle>
              <CardDescription>
                Sign up with GitHub to connect your monorepos.
              </CardDescription>
            </CardHeader>
